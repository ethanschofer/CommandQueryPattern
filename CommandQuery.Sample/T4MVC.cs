...
{
    public static CommandQuery.Sample.Controllers.BaseController Base = new CommandQuery.Sample.Controllers.T4MVC_BaseController();
    public static CommandQuery.Sample.Controllers.BlogController Blog = new CommandQuery.Sample.Controllers.T4MVC_BlogController();
    public static CommandQuery.Sample.Controllers.HomeController Home = new CommandQuery.Sample.Controllers.T4MVC_HomeController();
